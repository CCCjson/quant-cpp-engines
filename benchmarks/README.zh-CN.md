...
在 benchmarks/data/cpp_bars.json（180 根真实日线，与 parity 门禁同一份） 上：

- **MACD** — 七项经济指标全部 0.00e+00 → 决定扩入门禁
- **KDJ** — 七项经济指标全部 0.00e+00 → 决定扩入门禁
- **RSI** — 最终资产差 5.58e+04 → 决定**不扩**，把分歧查清写进 README，不降门禁
